...
using AppWeb.Models;
using AppWeb.Models.Enuns;

namespace AppWeb.Data
{
    public class SeedingService
    {
        private AppWebContext _context;

        public SeedingService(AppWebContext context)
        {
            _context = context;
        }
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(2005,04,08),1000.0, d1);
            Seller s2 = new Seller(2, "Karol Stein", "karolzinha@gmail.com", new DateTime(2005,07,07), 900.0, d2);
            Seller s3 = new Seller(3, "Marcos Borget", "marcos@hotmail.com", new DateTime(2003,07,09),1200.0,d3);
            Seller s4 = new Seller(4, "Elisa Eleoterio", "elisa@gmail.com", new DateTime(2005,07,06), 700.0, d4);
            Seller s5 = new Seller(5, "Lucas Dickman", "luquinhas@hotmail.com", new DateTime(2005,08,12), 1200.00, d1);
            Seller s6 = new Seller(6, "Gabriel Labes", "gdlabes@gmail.com", new DateTime(2005,12,10), 1400.00, d1);
